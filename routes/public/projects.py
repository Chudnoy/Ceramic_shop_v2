...
from services.public_project_service import (
    get_public_project_page_data,
    get_public_projects_page_data,
)
...
def projects_index():
    ...
    return render_template(
        "public/projects.html", projects=page_data["projects"], sort=sort
    )
